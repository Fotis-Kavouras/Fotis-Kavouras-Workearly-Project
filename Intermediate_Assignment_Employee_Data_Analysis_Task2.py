...
dept_analysis = df.groupby('Department').agg({'Salary': 'mean', 'EmpSatisfaction': 'mean'}).reset_index()
...
ax2 = ax1.twinx()
ax2.plot(dept_analysis['Department'], dept_analysis['EmpSatisfaction'], color='r', marker='o',
         label='Average Employee Satisfaction')
